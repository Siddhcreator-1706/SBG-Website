                ...
                <div className="grid gap-4 py-4">
                    {currentUser?.role === 'admin' && (
                        <div className="grid gap-2">
                            ...
                            <Select value={selectedClubId || ''} onValueChange={setSelectedClubId}>
                                <SelectTrigger className="border-borderSoft text-textPrimary">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            className="rounded-xl border-borderSoft text-textPrimary"
                        />
                    </div>
                    <div className="grid gap-2">
                        ...
                        <Select value={newEvent.event_type} onValueChange={val => setNewEvent({ ...newEvent, event_type: val })}>
                            <SelectTrigger className="rounded-xl border-borderSoft text-textPrimary">
                            ...
                            {[{ id: 'online', name: 'Online' }, ...venues].map(v => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`px-3 py-1 text-sm cursor-pointer rounded-full border transition-colors ${isSelected ? 'bg-brand text-white border-brand' : 'bg-transparent text-textSecondary border-borderSoft hover:border-brand/50'
                                            }`}
                                    >
                                        {v.name}
                                    </button>
