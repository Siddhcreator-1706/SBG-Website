            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        className="fixed inset-x-4 top-[72px] sm:absolute sm:inset-auto sm:right-0 sm:top-full sm:mt-2 w-auto sm:w-[400px] max-h-[80dvh] sm:max-h-[480px] rounded-2xl border border-borderSoft bg-popover shadow-[0_16px_64px_rgba(0,0,0,0.15)] dark:shadow-[0_16px_64px_rgba(0,0,0,0.5)] z-50 flex flex-col overflow-hidden"
                    >
                        {/* Header */}
